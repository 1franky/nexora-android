...
fun CreateInstallmentPlanSheet(
    ...
    if (quickCreateCategory) {
        QuickCreateCategoryDialogInstallments(
...
private fun CategoryDropdown(categories: List<Category>, selectedId: String?, onSelect: (String) -> Unit) {
    ...
    ExposedDropdownMenuBox(expanded = expanded, onExpandedChange = { expanded = it }) {
        OutlinedTextField(
            ...
            onValueChange = {},
            readOnly = true,
            label = { Text(stringResource(R.string.installments_dialog_category)) },
...
@Composable
private fun QuickCreateCategoryDialogInstallments(onDismiss: () -> Unit, onCreate: (String) -> Unit) {
