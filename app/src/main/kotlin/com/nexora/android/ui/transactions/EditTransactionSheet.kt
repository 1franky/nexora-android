...
import com.nexora.android.ui.cards.CategoryDropdown
...
/** Solo para INCOME/EXPENSE — transferencias y movimientos de tarjeta no se editan desde Movimientos. */
...
fun EditTransactionSheet(
    ...
    val viewModel = remember { EditTransactionViewModel(transactionRepository, categoryRepository, transaction) }
    ...
    val categoryType = if (transaction.type == TransactionType.INCOME) CategoryType.INCOME else CategoryType.EXPENSE
    ...
    ModalBottomSheet(onDismissRequest = onDismiss, sheetState = sheetState) {
        Column(
            ...
            Text(stringResource(R.string.transactions_edit_title), style = MaterialTheme.typography.titleLarge)
